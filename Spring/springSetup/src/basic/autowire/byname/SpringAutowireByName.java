...
public class SpringAutowireByName {
	...
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("spring-autowire-by-name.xml");
//		context = new FileSystemXmlApplicationContext("spring-di-by-constructor.xml");
		...
		Resource res = new ClassPathResource("spring-autowire-by-name.xml");
